...
import           Level04.DB.Types           (DBComment, dbCommentId, dbCommentTopic, dbCommentComment, dbCommentTime)
...
encodeComment =
  E.mapLikeObj $ \comment ->
    E.intAt "id" (getCommentId $ commentId comment) .
